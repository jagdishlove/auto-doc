  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <div
          className="flex items-center gap-2.5 cursor-pointer px-4"
          onClick={() => navigate("/")}
        >
          <img src="/logo.svg" alt="AutoDoc AI" className="w-8 h-8" />
          <span className="font-bold text-xl text-white">AutoDoc AI</span>
        </div>
        ...
        <nav className="hidden md:flex items-center space-x-6">
          {links.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="text-sm font-medium text-gray-400 hover:text-brand-400 transition-colors"
            >
              {l.label}
            </a>
          ))}
        ...
        <div className="hidden md:flex items-center space-x-3 px-4">
          ...
          <a
            href="/login"
            className="bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-brand-500 transition-colors"
          >
            Get Started
          </a>
        </div>
          ...
          <div className="flex flex-col space-y-2 pt-3 px-4">
            {links.map((l) => (
              <a
                ...
                className="text-sm font-medium text-gray-400 hover:text-brand-400 py-2"
              >
                {l.label}
              </a>
            ))}
            <div className="flex flex-col space-y-2 pt-2 border-t border-white/10">
              ...
              <a
                href="/login"
                className="bg-brand-600 text-white px-4 py-2 rounded-lg text-sm font-medium text-center hover:bg-brand-500 transition-colors"
              >
                Get Started
              </a>
            </div>
...
const HeroSection: React.FC = () => (
  <section className="relative overflow-hidden bg-dark-950 pt-14 pb-16 px-6">
    ...
    <div className="max-w-7xl mx-auto relative">
      <div className="flex flex-col md:flex-row items-center gap-10">
        <div className="w-full md:w-1/2">
          <span className="inline-block bg-brand-500/10 text-brand-400 border border-brand-500/20 px-4 py-1 rounded-full text-sm font-semibold mb-5">
            Introducing AutoDoc AI
          </span>
          <h1 className="text-4xl md:text-5xl font-bold mb-5 text-white leading-tight">
            Generate{" "}
            <span className="text-brand-400">API Docs Instantly</span>
            {" "}with AI
          </h1>
          <p className="text-lg mb-7 text-gray-400 leading-relaxed">
            Connect your GitHub repo. We scan your codebase with AST parsing and
            Gemini AI to produce beautiful API documentation in seconds.
          </p>
          <a
            href="/login"
        ...
        <div className="w-full md:w-1/2 h-[380px] relative hidden md:block">
          <div className="absolute top-0 right-8 w-60 bg-dark-900 border border-white/10 rounded-xl shadow-2xl p-4 animate-float">
          ...
          <div className="absolute top-16 right-44 w-52 bg-dark-900 border border-white/10 rounded-xl shadow-2xl p-4 animate-float-delayed">
          ...
          <div className="absolute bottom-6 right-12 w-56 bg-dark-900 border border-white/10 rounded-xl shadow-2xl p-4 animate-float">
            <div className="flex items-center gap-2 mb-3">
          ...
          <div className="absolute bottom-16 right-48 w-48 bg-dark-900 border border-white/10 rounded-xl shadow-2xl p-3 animate-float-delayed">
            <div className="flex items-center gap-2 mb-2">
...
const HowItWorks: React.FC = () => {
  ...
  return (
    <section className="py-14 px-6 bg-dark-900 relative overflow-hidden">
...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section className="py-14 px-6 bg-dark-950" id="features">
...
const PricingSection: React.FC = () => {
  ...
  return (
    <section className="py-14 px-6 bg-dark-900" id="pricing">
      <div className="max-w-7xl mx-auto">
...
const FAQSection: React.FC = () => {
  ...
  return (
    <section className="py-14 px-6 bg-dark-950" id="faq">
      <div className="max-w-3xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-1 text-white">
          FAQ
        </h2>
        <p className="text-center text-gray-400 mb-10 text-sm">
...
const Footer: React.FC = () => (
  <footer className="bg-dark-950 border-t border-white/5 py-10" id="contact">
